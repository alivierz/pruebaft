...
export class PhotoIDScanProcessor implements FaceTecIDScanProcessor {
  ...
  public onFaceTecSDKCompletelyDone = (): void => {
    ...
    // this.sampleAppControllerReference.onCompletePhotoIdScan(null, this.latestIDScanResult, this.latestNetworkRequest.status);

    this.callbackData({value: null, valuedos: this.latestIDScanResult,value3: this.latestNetworkRequest.status})
  };
